...
public class Result {
    ...
    public static ResponseEntity<ApiResult> ok(String message){
        ...
        return ResponseEntity.ok(ApiResult.message(message));
    }
    ...
    public static ResponseEntity<ApiResult> serverError(String message, String errorReferrenceCode){
        return ResponseEntity.status(500).body(ApiResult.error(message, errorReferrenceCode));
    }
